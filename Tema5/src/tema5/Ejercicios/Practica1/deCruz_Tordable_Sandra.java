...
public class deCruz_Tordable_Sandra {
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            nombre=sc.nextLine().trim();
                if (nombre.isEmpty()) {
                    ...
                    valido=false;
                }else if (app.contieneCaracteresEspeciales(nombre)) { //En caso de que el nombre sea menor que tres cracteres
        ...
        if (apellido1.isEmpty()) {
            ...
            }else if (apellido1.length()<2) { //En caso de que el nombre sea menor que tres cracteres
                    System.out.println("El apellido tiene que tener como minimo 2 letras. Intentelo de nuevo.");
                    valido=false;
            }else if (app.contieneCaracteresEspeciales(apellido1)) { 
        ...
        do{
            ...
            if (apellido2.isEmpty()) {
                    ...
                    System.out.println("El apellido tiene que tener como minimo 2 letras. Intentelo de nuevo.");
                    valido=false;
                }else if (app.contieneCaracteresEspeciales(apellido2)) { //En caso de que el nombre sea menor que tres cracteres
                    System.out.println("El apellido no puede contener caracteres especiales. Intentelo de nuevo.");
                    valido=false;
                }else{
                  valido=true; 
