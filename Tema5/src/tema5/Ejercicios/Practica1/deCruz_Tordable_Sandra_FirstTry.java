...
public class deCruz_Tordable_Sandra_FirstTry {
    ...
    public static void main(String[] args) {
        ...
        String caracteresEspeciales = "!@#$%/&()="; //Variable para detectar si hay caracteres especiales dentro de la contraseña
        ...
        if(contrasena1.length()<6){ //Comprobamos que tan segura es la contraseña generada.
            System.out.println("La primera contraseña generada es: "+contrasena1+" y es "+ROJO+" poco segura."+RESET);
        }else if(contrasena1.length() >= 6 && app.contieneCaracteresEspeciales(contrasena1, caracteresEspeciales)){
            System.out.println("La primera contraseña generada es: "+contrasena1+" y es "+VERDE+" muy segura."+RESET);
        }else{
            System.out.println("La primera contraseña generada es: "+contrasena1+" y es "+AMARILLO+" segura."+RESET);
        }
        
        //Mostramos la segunda contraseña
        if(contrasena2.length()<6){ //Comprobamos que tan segura es la contraseña generada.
            System.out.println("La segunda contraseña generada es: "+contrasena2+" y es "+ROJO+" poco segura."+RESET);
        }else if(contrasena2.length()>=6 && app.contieneCaracteresEspeciales(contrasena2, caracteresEspeciales)){
            System.out.println("La segunda contraseña generada es: "+contrasena2+" y es "+VERDE+" muy segura."+RESET);
        }else{
            System.out.println("La segunda contraseña generada es: "+contrasena2+" y es "+AMARILLO+" segura."+RESET);
        }
        
        //Mostramos la tercera contraseña
        if(contrasena3.length()<6){ //Comprobamos que tan segura es la contraseña generada.
            System.out.println("La tercera contraseña generada es: "+contrasena3+" y es "+ROJO+" poco segura."+RESET);
        }else if(contrasena3.length()>=6 && app.contieneCaracteresEspeciales(contrasena3, caracteresEspeciales)){
            System.out.println("La tercera contraseña generada es: "+contrasena3+" y es "+VERDE+" muy segura."+RESET);
        }else{
            System.out.println("La tercera contraseña generada es: "+contrasena3+" y es "+AMARILLO+" segura."+RESET);
        }
        System.out.println("----------------");
    }
}